...
<div class="axes-anim">
  ...
  <div class="axis-track">
    ...
    <div class="axis-to">
      ...
      <div class="ax-cell-label">image patches + robot joint actions</div>
    </div>
  </div>
  ...
  <div class="axis-track">
    <div class="axis-tag">
      ...
      <div>
        ...
        <div class="axis-hint">classification &nbsp;→&nbsp; regression (incl.&nbsp;flow matching)</div>
      </div>
    </div>
    <div class="axis-from">
...
<div class="axes-anim">
  ...
  <div class="axis-track">
    ...
    <div class="axis-to">
      ...
      <div class="ax-cell-label">图像 patch + 机械臂关节动作</div>
    </div>
  </div>
  ...
  <div class="axis-track">
    <div class="axis-tag">
      ...
      <div>
        ...
        <div class="axis-hint">分类 &nbsp;→&nbsp; 回归（含流匹配）</div>
      </div>
    </div>
    <div class="axis-from">
      <svg class="ax-onehot" viewBox="0 0 130 44" aria-hidden="true">
